...
<?php //Fetch Data From DataBase..
    ...
    $query = "SELECT sellerTitle, sellerPrice, sellerAddress, sellerDescript, sellerName, sellerPhone, images FROM advertisements WHERE sellerCategory ='apartment' ";
    ...
    if($result_set){
        ...
        $table = '<table class = "apartments-data">';
...
<head>
    ...
    <link rel="stylesheet" href="styles/apartmentspage.css">
 
    <!-- Js Linked -->
    <script>
        alert("Wellcome To Our Apartments Page");
    </script>
...
<!--*****************************************************************************************************************-->
        ...
        <!--navigation bar start-->
            ...
            <a class="active" href="#">Apartments</a>
...
<!--*****************************************************************************************************************-->
    ...
    <div>
        <center>
            <h1>Apartments for Sale in Sri Lanka</h1>
            ...
            <table border="0" class="footerTable">
                ...
                <tr>
                    ...
                    <td class="footLinks">
                        ...
                        <hr id="FootLine">
                        <a class="active" href="#">Apartments</a><br>
                        <hr id="FootLine">
