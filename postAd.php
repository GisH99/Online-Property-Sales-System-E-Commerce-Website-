...
<!--<?php
    ...
    //if(!isset($_SESSION['user_id'])){       /*Not passsing session id from loggin page*/
...
<?php //Insert Data To DataBase..  
    ...
    if(isset($_POST['post_ad_submit_btn'])){
        ...
        $sql = "INSERT INTO advertisements/*(id,sellerName,sellerPhone,sellerEmail,sellerCategory,sellerAddress,sellerTitle,sellerDescript,sellerPrice,'images')*/
        VALUES('','$sellerName','$sellerPhone','$sellerEmail','$sellerCategory','$sellerAddress','$sellerTitle','$sellerDescript','$sellerPrice','$images')";
        }
        ...
        if($result){
            ...
            echo"<script>alert('Error Inserting data,Image Size should be Less Than 500KB')</script>";
