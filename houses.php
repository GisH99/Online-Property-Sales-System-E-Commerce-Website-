...
<?php //Fetch Data From DataBase.....
      ...
      $query = "SELECT sellerTitle, sellerPrice, sellerAddress, sellerDescript, sellerName, sellerPhone, images FROM advertisements WHERE sellerCategory = 'house' ";
    ...
    if($result_set){
        ...
        $table = '<table class = "house-retrieve-data">';
        ...
        while ($record = mysqli_fetch_assoc($result_set)){
            ...
            $table .='<td><a href="$record[images]"><img src="imgupload/' .$record['images']. '" height="300px" width="400px"/></a></td>';
            $table .='</tr>';
        }
       $table .='</table>';
...
<head>
    ...
    <link rel="stylesheet" href="styles/housespage.css">
 
    <!-- Js Linked -->
    <script>
        alert("Wellcome To Our Houses Page");
    </script>
...
<!-- Midddle -->
    <div>
        <center>
            <h1>Houses for Sale in Sri Lanka</h1>
            ...
            <table border="0" class="footerTable">
                ...
                <tr>
                    ...
                    <td class="footLinks">
                        ...
                        <hr id="FootLine">
                        <a class="active"href="#">Houses</a><br>
                        <hr id="FootLine">
